 ...
 */
package org.mybatis.generator.plugins.ext.util;
...
public class PluginJavaBeansUtil {

    private PluginJavaBeansUtil() {
        super();
    }
    ...
    public static Field getJavaBeansField(IntrospectedColumn introspectedColumn,
        ...
        addGeneratedJavaDoc(field, context, introspectedColumn, introspectedTable,commentGenerator);
        return field;
    }
