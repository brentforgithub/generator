...
public class VoCompilationUnit extends InnerClass implements CompilationUnit {
    public VoCompilationUnit(FullyQualifiedJavaType type) {
        super(type);
    }

    public VoCompilationUnit(String type) {
        super(type);
    }
